...
IF "%DOCKER_USER%"=="" SET DOCKER_USER=hugodiasg
IF "%DOCKER_IMAGE%"=="" SET DOCKER_IMAGE=iic-osic-tools-asitic
IF "%DOCKER_TAG%"=="" SET DOCKER_TAG=latest

IF "%CONTAINER_USER%"=="" SET CONTAINER_USER=1000
IF "%CONTAINER_GROUP%"=="" SET CONTAINER_GROUP=1000

IF "%CONTAINER_NAME%"=="" SET CONTAINER_NAME=iic-osic-tools-asitic_xvnc
